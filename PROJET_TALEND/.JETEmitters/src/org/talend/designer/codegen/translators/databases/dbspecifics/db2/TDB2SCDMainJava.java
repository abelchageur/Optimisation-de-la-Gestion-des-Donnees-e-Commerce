...
public class TDB2SCDMainJava {
  ...
  protected final String TEXT_100 = NL + "    }" + NL + "    " + NL + "    } catch (java.lang.Exception e) {//catch" + NL + "globalMap.put(\"";
  protected final String TEXT_101 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "  \t\t";
  ...
  protected final String TEXT_106 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_107 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_108 = NL + "                System.err.print(e.getMessage());";
  protected final String TEXT_109 = NL + "\t}//end catch" + NL + "\t";
  protected final String TEXT_110 = NL + "        cache_";
  protected final String TEXT_111 = ".put(lookUpKey_";
  protected final String TEXT_112 = ", lookUpValue_";
